...
def widerface_to_cocojson(root_path):
    ...
    print("Wider Face train2017 dataset converts sucess, the json path: {}".format(save_path))
    save_path = os.path.join(root_path, "widerface_val.json")
    widerface_convert(val_gt_txt, val_img_dir, save_path)
    print("Wider Face val2017 dataset converts sucess, the json path: {}".format(save_path))
...
def main():
    ...
    parser.add_argument(
        '--train_proportion',
        help='the proportion of train2017 dataset',
        type=float,
        default=1.0)
    parser.add_argument(
        '--val_proportion',
